...
const startDateField: string = "(//div[@data-testid='datePicker'])[1]//input";
...
const endDateField: string = "(//div[@data-testid='datePicker'])[2]//input";
...
const workPeriodDateField: string =
  "(//div[@data-testid='datePicker'])[3]//input";
...
class EditTenderPage extends BasePage {
  constructor(page: Page) {
    super(page);
  }

  public async checkEditTenderURL(): Promise<void> {
    await super.doesPageHaveURL(/\/edit-tender\//);
  }
  ...
  public async areBaseInfoFormElementsDisplayed(): Promise<void> {
    ...
    await super.isDisplayed(tenderServiceNameFieldValue);
  ...
  public async clearTenderNameField(): Promise<void> {
    await super.clearValue(tenderNameField);
  }

  public async isTenderNameEmpty(): Promise<void> {
  ...
  public async isStartDateFieldDisabled(): Promise<void> {
    await super.doesElementHaveAttr(startDateField, "readonly");
  }
  ...
  public async isEndDateFieldDisabled(): Promise<void> {
    await super.doesElementHaveAttr(endDateField, "readonly");
  }
  ...
  public async isWorkPeriodDateFieldDisabled(): Promise<void> {
    await super.doesElementHaveAttr(workPeriodDateField, "readonly");
  }
  ...
  public async clearBudgetAmountField(): Promise<void> {
    await super.clearValue(budgetAmountField);
  }
  ...
  public async clearAdditionalInfoTextarea(): Promise<void> {
    await super.clearValue(additionalInfoTextarea);
  }
  ...
  public async deleteDocumentationFile(): Promise<void> {
    await super.click(documentItemDeleteBtn);
  }

  public async isDocumentationFileNotDisplayed(): Promise<void> {
    await super.isNotDisplayed(documentItem);
  }
